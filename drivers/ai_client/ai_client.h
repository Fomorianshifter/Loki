 ...
 *
 * Build requirements:
 *   - libcurl  (Ubuntu/Debian: sudo apt-get install libcurl4-openssl-dev)
 *   - Link with: -lcurl
 */
 ...
 */
typedef struct {
    const char *api_url;    /**< Full endpoint URL */
 ...
 *
 * @param[in]  prompt        Null-terminated prompt string (max 2048 chars).
 ...
 *         HAL_INVALID_PARAM if any argument is NULL/zero.
 */
